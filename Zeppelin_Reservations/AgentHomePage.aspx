...
#main-container
{
   ...
   <div id="tab-container">
      <ul>
         ...
         <li><a href="#tab3">Cancel Reservation</a></li>
         <li><a href="#tab4">Manage Reservation</a></li>
         <li><a href="#tab5">Add Reservation</a></li>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Arrival Time
        ...
        <asp:RegularExpressionValidator ID="RegularExpressionValidator2" ControlToValidate="TextBox5" runat="server" ErrorMessage="Only Numbers allowed" ValidationExpression="\d+"></asp:RegularExpressionValidator>
        <br />
&nbsp;&nbsp; Departure Time
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
        ...
        <asp:RegularExpressionValidator ID="RegularExpressionValidator4" ControlToValidate="TextBox8" runat="server" ErrorMessage="Only Numbers allowed" ValidationExpression="\d+"></asp:RegularExpressionValidator>
        <br />
        <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
        Currency <asp:TextBox ID="TextBox9" runat="server"></asp:TextBox>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; N°of stops&nbsp;&nbsp;&nbsp;
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
        ...
        <asp:RegularExpressionValidator ID="RegularExpressionValidator5" ControlToValidate="TextBox13" runat="server" ErrorMessage="Only Numbers allowed" ValidationExpression="\d+"></asp:RegularExpressionValidator>
&nbsp;&quot;First Class&quot;<br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Button ID="Submit" runat="server" OnClick="Button1_Click" Text="Submit" />

   </div>
    <div class="main-container" id="tab3">
      <h3>Cancel Reservation<span><asp:GridView ID="GridView2" runat="server" 
              AutoGenerateColumns="False" BackColor="#CCCCCC" BorderColor="#999999" 
              BorderStyle="Solid" BorderWidth="3px" CellPadding="4" CellSpacing="2" 
              DataKeyNames="zres_ID" DataSourceID="SqlDataSource2" ForeColor="Black">
          <Columns>
              <asp:CommandField ShowDeleteButton="True" />
              <asp:BoundField DataField="zres_ID" HeaderText="zres_ID" ReadOnly="True" 
                  SortExpression="zres_ID" />
              <asp:BoundField DataField="zres_flightID" HeaderText="zres_flightID" 
                  SortExpression="zres_flightID" />
              <asp:BoundField DataField="zres_ClientID" HeaderText="zres_ClientID" 
                  SortExpression="zres_ClientID" />
              <asp:BoundField DataField="zres_quantity" HeaderText="zres_quantity" 
                  SortExpression="zres_quantity" />
              <asp:BoundField DataField="zres_class" HeaderText="zres_class" 
                  SortExpression="zres_class" />
          </Columns>
          <FooterStyle BackColor="#CCCCCC" />
          <HeaderStyle BackColor="Black" Font-Bold="True" ForeColor="White" />
          ...
          <asp:SqlDataSource ID="SqlDataSource2" runat="server" 
              ConflictDetection="CompareAllValues" 
              ConnectionString="<%$ ConnectionStrings:tahrisqallimConnectionString %>" 
              DeleteCommand="DELETE FROM [ZeppelinReservation] WHERE [zres_ID] = @original_zres_ID AND (([zres_flightID] = @original_zres_flightID) OR ([zres_flightID] IS NULL AND @original_zres_flightID IS NULL)) AND (([zres_ClientID] = @original_zres_ClientID) OR ([zres_ClientID] IS NULL AND @original_zres_ClientID IS NULL)) AND (([zres_quantity] = @original_zres_quantity) OR ([zres_quantity] IS NULL AND @original_zres_quantity IS NULL)) AND (([zres_class] = @original_zres_class) OR ([zres_class] IS NULL AND @original_zres_class IS NULL))" 
              InsertCommand="INSERT INTO [ZeppelinReservation] ([zres_ID], [zres_flightID], [zres_ClientID], [zres_quantity], [zres_class]) VALUES (@zres_ID, @zres_flightID, @zres_ClientID, @zres_quantity, @zres_class)" 
              OldValuesParameterFormatString="original_{0}" 
              SelectCommand="SELECT [zres_ID], [zres_flightID], [zres_ClientID], [zres_quantity], [zres_class] FROM [ZeppelinReservation]" 
              UpdateCommand="UPDATE [ZeppelinReservation] SET [zres_flightID] = @zres_flightID, [zres_ClientID] = @zres_ClientID, [zres_quantity] = @zres_quantity, [zres_class] = @zres_class WHERE [zres_ID] = @original_zres_ID AND (([zres_flightID] = @original_zres_flightID) OR ([zres_flightID] IS NULL AND @original_zres_flightID IS NULL)) AND (([zres_ClientID] = @original_zres_ClientID) OR ([zres_ClientID] IS NULL AND @original_zres_ClientID IS NULL)) AND (([zres_quantity] = @original_zres_quantity) OR ([zres_quantity] IS NULL AND @original_zres_quantity IS NULL)) AND (([zres_class] = @original_zres_class) OR ([zres_class] IS NULL AND @original_zres_class IS NULL))">
              <DeleteParameters>
                  <asp:Parameter Name="original_zres_ID" Type="Int32" />
                  <asp:Parameter Name="original_zres_flightID" Type="Int32" />
                  <asp:Parameter Name="original_zres_ClientID" Type="Int32" />
                  <asp:Parameter Name="original_zres_quantity" Type="Int32" />
                  <asp:Parameter Name="original_zres_class" Type="String" />
              </DeleteParameters>
              <InsertParameters>
                  <asp:Parameter Name="zres_ID" Type="Int32" />
                  <asp:Parameter Name="zres_flightID" Type="Int32" />
                  <asp:Parameter Name="zres_ClientID" Type="Int32" />
                  <asp:Parameter Name="zres_quantity" Type="Int32" />
                  <asp:Parameter Name="zres_class" Type="String" />
              </InsertParameters>
              <UpdateParameters>
                  <asp:Parameter Name="zres_flightID" Type="Int32" />
                  <asp:Parameter Name="zres_ClientID" Type="Int32" />
    ...
    <div class="main-container" id="tab4">
        <asp:GridView ID="GridView3" runat="server" AllowSorting="True" 
            AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" 
            BorderStyle="Solid" BorderWidth="1px" CellPadding="3" DataKeyNames="zres_ID" 
            DataSourceID="SqlDataSource4" ForeColor="Black" GridLines="Vertical">
            <AlternatingRowStyle BackColor="#CCCCCC" />
            <Columns>
                <asp:CommandField ShowEditButton="True" />
                <asp:BoundField DataField="zres_ID" HeaderText="Reservation ID" 
                    InsertVisible="False" ReadOnly="True" SortExpression="zres_ID" />
                <asp:BoundField DataField="zres_flightID" HeaderText="Flight ID" 
                    SortExpression="zres_flightID" />
                <asp:BoundField DataField="zres_clientID" HeaderText="Client ID" 
                    SortExpression="zres_clientID" />
                <asp:BoundField DataField="zres_quantity" HeaderText="Quantity" 
                    SortExpression="zres_quantity" />
                <asp:BoundField DataField="zres_class" HeaderText="Class" 
                    SortExpression="zres_class" />
                <asp:BoundField DataField="zres_rating" HeaderText="Rating" ReadOnly="True" 
                    SortExpression="zres_rating" />
                <asp:BoundField DataField="zres_comment" HeaderText="Comment" ReadOnly="True" 
                    SortExpression="zres_comment" />
                <asp:BoundField DataField="zres_date" HeaderText="Date" 
                    SortExpression="zres_date" />
            </Columns>
            <FooterStyle BackColor="#CCCCCC" />
            <HeaderStyle BackColor="Black" Font-Bold="True" ForeColor="White" />
            <PagerStyle BackColor="#999999" ForeColor="Black" HorizontalAlign="Center" />
        ...
        <asp:SqlDataSource ID="SqlDataSource4" runat="server" 
            ConnectionString="<%$ ConnectionStrings:tahrisqallimConnectionString %>" 
            DeleteCommand="DELETE FROM [ZeppelinReservation] WHERE [zres_ID] = @zres_ID" 
            InsertCommand="INSERT INTO [ZeppelinReservation] ([zres_flightID], [zres_clientID], [zres_quantity], [zres_class], [zres_rating], [zres_comment], [zres_date]) VALUES (@zres_flightID, @zres_clientID, @zres_quantity, @zres_class, @zres_rating, @zres_comment, @zres_date)" 
            SelectCommand="SELECT [zres_ID], [zres_flightID], [zres_clientID], [zres_quantity], [zres_class], [zres_rating], [zres_comment], [zres_date] FROM [ZeppelinReservation]" 
            UpdateCommand="UPDATE [ZeppelinReservation] SET [zres_flightID] = @zres_flightID, [zres_clientID] = @zres_clientID, [zres_quantity] = @zres_quantity, [zres_class] = @zres_class, [zres_rating] = @zres_rating, [zres_comment] = @zres_comment, [zres_date] = @zres_date WHERE [zres_ID] = @zres_ID">
            <DeleteParameters>
                <asp:Parameter Name="zres_ID" Type="Int32" />
            </DeleteParameters>
            <InsertParameters>
                ...
                <asp:Parameter Name="zres_quantity" Type="Int32" />
                <asp:Parameter Name="zres_class" Type="String" />
                <asp:Parameter Name="zres_rating" Type="Int32" />
                <asp:Parameter Name="zres_comment" Type="String" />
                <asp:Parameter Name="zres_date" Type="String" />
            </InsertParameters>
            <UpdateParameters>
                <asp:Parameter Name="zres_flightID" Type="Int32" />
                <asp:Parameter Name="zres_clientID" Type="Int32" />
     ...
     <div class="main-container" id="tab5">
         <table style="width: 100%;">
             <tr>
                 <td class="auto-style1">Flight ID</td>
                 <td>
                     <asp:TextBox ID="TextBox15" runat="server" Width="263px"></asp:TextBox>
                 </td>
             </tr>
             <tr>
                 <td class="auto-style1">Client ID</td>
                 <td>
                     <asp:TextBox ID="TextBox16" runat="server" Width="267px"></asp:TextBox>
                 </td>
             </tr>
             <tr>
                 <td class="auto-style1">Reservation Quantity</td>
                 <td>
             ...
             <tr>
                 <td class="auto-style1">Reservation Class</td>
                 <td>
                     <asp:TextBox ID="TextBox17" runat="server" Width="267px"></asp:TextBox>
                 </td>
             </tr>
             <tr>
             ...
             <tr>
                 <td class="auto-style1">&nbsp;</td>
                 <td>
                     <asp:TextBox ID="TextBox18" runat="server" Width="632px"></asp:TextBox>
                 </td>
             </tr>
         </table>
     </div>
