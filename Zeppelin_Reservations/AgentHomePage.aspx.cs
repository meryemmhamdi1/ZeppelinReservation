...
public partial class AgentHomePage : System.Web.UI.Page
{
    ...
    protected void Button1_Click1(object sender, EventArgs e)
    {
        ...
        pdfDoc.Add(new Paragraph("                   Graph: Number of reservations made per month "));
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        if (IsPostBack)
        {
            try
            {
                string qry = "INSERT INTO ZeppelinReservation( zres_flightID, zres_clientID, zres_quantity, Z.zres_class, zres_date) VALUES ('" + TextBox15.Text + " ', '" +
               TextBox16.Text + "', " + Int32.Parse(DropDownList1.SelectedValue.ToString()) +", '" + TextBox17.Text + "' ,'" + DateTime.Now.ToString("M/d/yyyy") + "', )";
                TextBox18.Text = qry;
                SqlConnection dbConnection = new SqlConnection();
                dbConnection.ConnectionString =
                "server=SSEDB;user=tahrisqallim;password=datadata2014;database=tahrisqallim";
